...
/**
 * @description
 * Connect the token at the engine.
 * @param token {Token}
 * Token generated by DSLEngine
 */
Collection.prototype.connectToken = function (token) {
	this.token = token;
	this.setEvent();
};
 ...
 */
CollectionEngine.prototype.editDocument = function (collectionId, documentId, content) {
    var collection = this.registry[collectionId];
 ...
 */
CollectionEngine.prototype.getShowPage = function (collectionId, documentId) {
    var collection = this.registry[collectionId];
